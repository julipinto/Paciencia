...
Ela pode se comportar como uma classe pai (A classe só tem uma lista de cartas ex.: `Baralho`) ou como um atributo normal (ex.: caso excepcional `Remanecente` onde se tem duas listas de cartas)
...
Onde se instancia o jogo com todos os seus componentes.
